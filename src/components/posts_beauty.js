...
import { fetchPostsBeauty, fetchUser, fetchSidebar } from '../actions';

class PostsBeauty extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    this.props.fetchPostsBeauty(this.state.limit);
...
export default connect(mapStateToProps, { fetchPostsBeauty, fetchUser, fetchSidebar })(PostsBeauty);